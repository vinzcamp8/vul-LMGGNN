...
def run_ivdetect(args, train_loader, val_loader, test_loader):
    ...
    path_output_model = f"{PATHS.model}ivdetect_{learning_rate}_{batch_size}_{epochs}_{weight_decay}/"
    ...
    for epoch in range(1, epochs + 1):
        ...
        if f1 > best_f1 or (f1 == best_f1 and recall > best_recall):
            ...
            checkpoint_path = str(path_output_model+"ivdetect_checkpoint.pth")
    ...
    path_checkpoint = str(path_output_model+"ivdetect_checkpoint.pth")
