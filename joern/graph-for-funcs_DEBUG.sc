...
@main def main(): Json = {
  GraphForFuncsResult(
    cpg.method.filterNot(_.fullNameExact("match")).map { method =>
      val methodName = method.fullName
      println(s"Parsing function: $methodName") // Debug print
      ...
      println(s"Parsing function: $methodName 2") // Debug print
      val local = new NodeSteps(
        methodVertex
          ...
          .cast[nodes.Local])
      println(s"Parsing function: $methodName 3") // Debug print
      ...
      println(s"Parsing function: $methodName 4") // Debug print
      ...
      println(s"Parsing function: $methodName 5") // Debug print
