...
from models.utils import GlobalMaxPool, GCNConvGrad

my_hidden_size = 769 # 128 
my_feature_representation_size = 769 # 128
my_num_node_features = 5 # 5
my_num_classes = 2 # 2
my_num_layers = 3 # 3
my_dropout_rate = 0.3 # 0.3

# If wants to reduce the embedding size, 
# change the my_feature_representation_size and my_hidden_size to the desired size
...
class IVDetectModel(nn.Module):
    def __init__(self, need_node_emb=False):
        ...
        self.h_size = my_hidden_size
        self.hidden_dim = my_hidden_size
        self.num_node_feature = my_num_node_features
        self.num_classes = my_num_classes
        self.input_size = my_feature_representation_size
        self.feature_representation_size = my_feature_representation_size
        self.drop_out_rate = my_dropout_rate
        self.layer_num = my_num_layers
